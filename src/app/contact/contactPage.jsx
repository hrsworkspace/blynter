...
const FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSdkv3Ilb-rygMxl81XSWmuZxyyBZL7mekZFbA3PFD2q20lz_Q/formResponse";
const FIRST_NAME_ID = "entry.1799011345";
const LAST_NAME_ID = "entry.1612769872";
const EMAIL_ID = "entry.1261040501";
const PHONE_ID = "entry.1905348101";
const MESSAGE_ID = "entry.2131043775";
...
export default function ContactPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        queryString.append(FIRST_NAME_ID, values.firstName);
        queryString.append(LAST_NAME_ID, values.lastName);
        queryString.append(EMAIL_ID, values.email);
        queryString.append(PHONE_ID, values.phone);
        queryString.append(MESSAGE_ID, values.message);

        try {
            // 'no-cors' is necessary because Google Forms doesn't return CORS headers
            await fetch(`${FORM_URL}?${queryString.toString()}`, {
                method: 'POST',
                mode: 'no-cors',
            });
